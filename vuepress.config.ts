...
export default defineUserConfig({
  ...
  title: '学习资料',
  // 网站的简介，有助于搜索引擎收录
  description: '高中相关资料分享，一切资料收集于互联网，若有侵权请联系本人删除。',
  ...
  theme: FileList([
    ...
    {
      mountPath: "/",
      analysis: githubReleasesFilesAnalysis({ user: "Lykisun", repository: "mathstorage" , authorizationToken: process.env.githubToken,}),
